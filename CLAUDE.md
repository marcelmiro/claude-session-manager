...
- **View toggle** (transitional): `localStorage["c0-view"]`, default `"inbox"`; the classic repo-grouped list renders unchanged behind it. The navbar ⚡/🔄 chips are gone in inbox view — section header counts carry that answer (the 🤖 pill stays).
